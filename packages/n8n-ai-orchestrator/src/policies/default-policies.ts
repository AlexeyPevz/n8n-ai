import type { DiffPolicy } from './diff-policies.js';

// Default policies for different environments
export const developmentPolicies: DiffPolicy[] = [
  {
...
export const productionPolicies: DiffPolicy[] = [
  {
    type: 'node_whitelist',
    enabled: true,
    whitelist: [
...
export const strictPolicies: DiffPolicy[] = [
  ...productionPolicies,
  {
    type: 'operation_limit',
    enabled: true,
...
export function getDefaultPolicies(environment?: string): DiffPolicy[] {
...
export function mergePolicies(custom: DiffPolicy[], defaults: DiffPolicy[]): DiffPolicy[] {
