...
describe('AI Routes', () => {
    ...
    describe('Security', () => {
        it('should allow requests without token when not configured', () => {
            const authMiddleware = router.stack.find(layer => layer.name === 'authMiddleware')?.handle;
            if (authMiddleware) {
    ...
    describe('Rate Limiting', () => {
        it('should set rate limit headers', () => {
            const rateLimitMiddleware = router.stack.find(layer => layer.name === 'rateLimitMiddleware')?.handle;
