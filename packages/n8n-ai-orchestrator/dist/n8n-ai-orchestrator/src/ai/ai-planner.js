...
export class AIPlanner {
    ...
    async plan(context) {
        try {
            ...
            const systemTemplate = PromptEngineer.selectTemplate({ complexity, requestType: 'create' }, 'system');
            const plannerTemplate = PromptEngineer.selectTemplate({ complexity, requestType: 'create' }, 'planner');
            // Build prompts
